  ...
  <body class="fixed-header ">
    ...
    <div class="login-wrapper ">
      ...
      <div class="bg-pic">
        ...
        <img src="../../img/thrift-shop2.jpg" data-src="../../img/thrift-shop2.jpg" data-src-retina="../../img/thrift-shop2.jpg" alt="" class="lazy">
        <!-- END Background Pic-->
        <!-- START Background Caption-->
        <div class="bg-caption pull-bottom sm-pull-bottom text-white p-l-20 m-b-20">
          <h2 class="semi-bold text-white"><b>MININATO</b><br> an online library that provide all you need.</h2>
        </div>
